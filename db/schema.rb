...
ActiveRecord::Schema[8.1].define(version: 2026_07_19_183000) do
  ...
  create_table "dish_categories", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["category_type"], name: "index_dish_categories_on_category_type"
    t.index ["position"], name: "index_dish_categories_on_position"
  end
  ...
  create_table "dishes", force: :cascade do |t|
    ...
    t.index ["position"], name: "index_dishes_on_position"
  end

  create_table "menu_cards", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "title", default: "Carte du restaurant", null: false
    t.datetime "updated_at", null: false
  end
